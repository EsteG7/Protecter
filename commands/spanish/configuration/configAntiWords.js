        ...
        try {
            ...
            if(guildData.premium.actived === true) {
                ...
                await message.reply({embeds: [
                    ...
                    .addComponents(
                        new MessageButton()
                            .setCustomId(`on antiWords:${message.author.id}`)
                            .setEmoji("✅")
                            .setLabel("ACTIVAR")
                        ...
                        new MessageButton()
                            .setCustomId(`off antiWords:${message.author.id}`)
                            .setEmoji("❎")
                            .setLabel("DESACTIVAR")
                        ...
                        new MessageButton()
                            .setCustomId(`add words:${message.author.id}`)
                            .setEmoji("🔼")
                            .setLabel("AÑADIR")
                            .setDisabled(false)
                            .setStyle("SECONDARY"),
                        ...
                        new MessageButton()
                            .setCustomId(`remove words:${message.author.id}`)
                            .setEmoji("🔽")
                            .setLabel("REMOVER")
                            .setDisabled(system.list.length === 0 ? true : false)
                            .setStyle("SECONDARY")
                    )
                ...
                await message.reply({embeds: [
                    ...
                    .addComponents(
                        ...
                        new MessageButton()
                            ...
                            .setEmoji("🔼")
                            .setLabel("AÑADIR")
                            .setDisabled(system.list.length >= 4 ? true : false)
                            .setStyle("SECONDARY"),
